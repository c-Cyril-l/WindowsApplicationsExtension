...
namespace Applications.Commands
{
    ...
    internal sealed class ControlPanel
    {
        ...
        private ControlPanel(OleMenuCommandService commandService)
        {
        ...
        {
            // Switch to the main thread - the call to AddCommand in ControlPanel's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new ControlPanel(commandService);
        }
        ...
        {
            Launcher.Launch(ApplicationPath.ControlPanel);
