...
namespace Applications.Commands
{
    ...
    internal sealed class ResourceMonitor
    {
        ...
        private ResourceMonitor(OleMenuCommandService commandService)
        {
        ...
        {
            // Switch to the main thread - the call to AddCommand in ResourceMonitor's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new ResourceMonitor(commandService);
        }
        ...
        {
            Launcher.Launch(ApplicationPath.ResourceMonitor);
