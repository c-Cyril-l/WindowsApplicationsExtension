...
namespace Applications.Commands
{
    ...
    internal sealed class TaskManager
    {
        ...
        private TaskManager(OleMenuCommandService commandService)
        {
        ...
        {
            // Switch to the main thread - the call to AddCommand in TaskManager's constructor requires
            // the UI thread.
        ...
        {
            Launcher.Launch(ApplicationPath.TaskManager);
        }
    }
}
