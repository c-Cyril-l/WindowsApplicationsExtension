...
namespace Applications.Commands
{
    ...
    internal sealed class Notepad
    {
        ...
        private Notepad(OleMenuCommandService commandService)
        {
        ...
        {
            // Switch to the main thread - the call to AddCommand in Notepad's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new Notepad(commandService);
        }
        ...
        {
            Launcher.Launch(ApplicationPath.Notepad);
